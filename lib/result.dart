                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => ThankYouPage(
                        ...
                        // ถ้ามี stats จาก backend ก็ส่งมาด้วย:
                        modelAvgAccuracy: 0.75,
                        totalInferences: 20,
                      ),
                    ),
                  );
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => AnalysisResultPage(
                    userId: widget.userId,
                    imagePath: widget.imagePath, // ส่งรูปที่เพิ่งถ่าย/อัปโหลด
                    predictedLabel:
                        _label, // ส่งชื่อพืชที่ AI ทำนายได้ (String?)
                    confidence: _confidence, // ส่งค่า confidence (double?)
                  ),
                ),
              );
            },
